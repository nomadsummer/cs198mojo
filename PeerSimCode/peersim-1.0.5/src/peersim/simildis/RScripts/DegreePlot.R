...
degree_values <- read.table("/Domain/tudelft.net/Users/rdelavizaghbolagh/Documents/triblerws/pubsub/src/peersim/simildis/result/DegreeDist.txt", skip=1, sep='|',col.names = c("index","degree"))

attach(degree_values)
#png(myarg[5])
